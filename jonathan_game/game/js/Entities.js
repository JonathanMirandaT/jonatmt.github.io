...
randomlyGenerateEnemy = function(){
	...
	var height = 80;	//between 10 and 40
	var width = 80;
	var id = Math.random();
...
Bullet2 = function (id,x,y,spdX,spdY,width,height,combatType){
	var self = Entity('bullet2',id,x,y,spdX,spdY,width,height,Img.bullet2);
...
generateBullet2 = function(actor,aimOverwrite){
	//Math.random() returns a number between 0 and 1
	var x = actor.x;
	var y = actor.y;
	var height = 24;
